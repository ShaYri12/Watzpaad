  ...
  return (
    <div className="bg-[#09121D]">
      <div className="relative w-full md:h-[500px] h-[362px]">
        <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center gap-[28px]">
          <img
          ...
          <h1 className="text-primaryColor text-[35px] text-center md:text-[65px] md:leading-[74.74px] leading-[40.25px] font-[700] relative z-[3] max-w-[587px] mx-auto">
            MetaAltPad NFT Marketplace
          </h1>
          <div className="flex flex-wrap gap-[23px] relative z-[3] max-w-[587px] mx-auto">
            <button className="flex-grow bg-primaryColor hover:bg-teal-300 w-[170.51px] text-[19px] md:text-[15.9px] transition text-black py-[13px] px-4 rounded-full">
              Create NFT
            </button>
            <button className="flex-grow bg-transparent hover:bg-gray-700 hover:bg-opacity-[0.3] text-primaryColor w-[170.51px] text-[19px] md:text-[15.9px] transition py-[13px] px-4 rounded-full border border-primaryColor">
              Sell NFT
            </button>
          </div>
        </div>
