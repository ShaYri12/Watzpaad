    ...
    <div className="min-h-screen bg-[#09121D] p-6 pb-[100px] pt-[160px]">
      ...
      >
        ...
        <p className="text-[16.69px] md:text-[18px] font-[400] text-[#798DA3]">
          ...
          <br />
          3.The market will charge 15% of the seller’s revenue as a service fee,
          of which 5% is send to original Minter. 5% Will transfer to the Reward
          to all NFT holders 5% to the Marketing Wallet.
        </p>
      </div>
    </div>
  );
