...
const faqData = [
  {
    question: "What is blockboost token?",
    answer: "Unique WEB3 Crowdfunding Ecosystem with unique rewards systems.",
  },
  {
    question:
  ...
  {
    question: "Will my rewards always paid hourly?",
    answer:
      "Yes, you have to claim the reward from our official dapp via connecting your wallet.",
  },
  {
    question: "How can I eligible for the presale rewards?",
    answer:
  ...
  {
    question: "How many stage are there in presale?",
    answer:
...
const FAQItem = ({ item }) => {
  ...
  return (
    <div className="mb-[19px]">
      <button className="card-border-faq w-full p-[3.33px]">
        <div
