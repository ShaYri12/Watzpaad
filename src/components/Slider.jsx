...
const Slider = () => {
    ...
    const handleMouseMove = (event) => {
        ...
        let left = event.clientX - sliderRect.left - thumbRef.current.offsetWidth / 2;
    ...
    const handleTrackClick = (e) => {
        ...
        updateSlider(Math.max(0, Math.min(left, sliderRect.width - thumbRef.current.offsetWidth)));
    };
