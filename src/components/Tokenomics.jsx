    ...
    <div className='w-full px-4'>
        ...
        <div className='w-full mt-20'>
            <div className='text-center text-white w-full max-w-[769px] mx-auto '>
                ...
                <p className='text-[18px] leading-[24px] font-light font-space'>Distribution of Token will take place after Presale ends. You will be able to claim the purchased $BBT Tokens from our presale page.</p>
            </div>
            <div className=' h-full max-w-[1240px] mx-auto w-full mt-12 flex lg:flex-row flex-col gap-5 items-center'>
                <div className='h-full text-white flex flex-col gap-4 w-full bg-custom-one border border-[#38DCC8] rounded-[22.77px] px-5 sm:px-8 py-6 sm:py-7 max-w-[816px] mx-auto'>
                    <div className='grid grid-cols-2 sm:flex justify-between flex-wrap gap-4'>
                        <div className='flex flex-col gap-1'>
                            ...
                            <h4 className='text-[14px] sm:text-[16px] leading-[26px] font-normal font-space'>Block boost token</h4>
                        </div>
                        <div className='flex flex-col gap-1'>
                            <h2 className='text-[16px] sm:text-[24px] font-bold'>Symbol</h2>
                            <h4 className='text-[14px] sm:text-[16px] leading-[26px] font-normal font-space'>$BBT</h4>
                        </div>
                        <div className='flex flex-col gap-1'>
                ...
                <div className='text-white h-full w-full flex flex-col justify-between gap-[25px] bg-custom-one border border-[#38DCC8] rounded-[22.77px] px-5 sm:px-8 py-6 sm:py-7 max-w-[400px] mx-auto'>
                    <div className='flex flex-col gap-0.5'>
                        <h2 className='text-[16px] leading-[19px] font-bold'>Presale Details</h2>
                        <h4 className='text-[#FFFFFF70] text-[12px] leading-[17px] font-normal'>The presale is live</h4>
                    </div>
                    <div className='flex flex-col gap-0.5'>
                        <h2 className='text-[16px] leading-[19px] font-bold'>Current $BBT Price</h2>
                        <h4 className='text-[#FFFFFF70] text-[12px] leading-[17px] font-normal'>1 $BBT = $0.001</h4>
                    </div>
                    <div className='flex flex-col gap-0.5'>
                        <h2 className='text-[16px] leading-[19px] font-bold'>Exchange Listing Price</h2>
                        <h4 className='text-[#FFFFFF70] text-[12px] leading-[17px] font-normal'>1 $BBT = $0.02</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className='mt-1 bg-tokenomics-image'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h1 className='text-[#38DCC8] text-[35px] sm:text-[50px] font-bold'>1,000,000,000</h1>
            </div>
        </div>
    </div>
  )
