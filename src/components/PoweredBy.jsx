  ...
  return (
    <div className="pb-[40px] pt-[80px] px-6 w-full">
      <div className="w-full max-w-[1240px] mx-auto">
        <h1 className="text-white text-[25px] leading-[28px] font-bold text-center">
          {" "}
          {t("powered-by.title")}
        </h1>
        <div className="mt-8 sm:mt-[70px] grid grid-cols-4 md:grid-cols-6 gap-3.5 md:gap-5 ">
          <div className="card-border w-full h-full p-[0.86px">
            <div className="rounded-[8.56px] relative z-[2]">
