  ...
  return (
    <section className="bg-dark-blue text-white px-[22px] md:pt-[80px] md:pt-[60px] sm:pt-[40px] pt-[10px] pb-[80px] sm:pb-[40px] pb-[20.93px] overflow-hidden relative">
      <img
        ...
        className="absolute top-0 left-0 w-full z-[1] object-cover h-full"
      />

      <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row justify-between items-center lg:h-[70vh] gap-[10px] relative z-[2] md:pt-0 pt-[20px]">
        {/* Left Section */}
        <div className="text-left max-w-[979px] mx-auto text-center">
          ...
          <div className="h-[3.04px] sm:h-[6px] w-[127px] sm:w-[251px] bg-primaryColor rounded-[20px] mt-[7px] md:mt-[14px] mx-auto"></div>
