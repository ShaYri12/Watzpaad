...
const LaunchedPadHero = () => {
  return (
    <section className="min-h-screen bg-dark-blue text-white lg:px-[22px] md:pt-[80px] pt-[60px] pb-[80px] pb-[29px] overflow-hidden">
      <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row justify-between items-center lg:h-[85vh] gap-[10px]">
        ...
        <div className="text-left lg:max-w-[601px] px-[22px]">
          ...
          <div className="h-[6px] w-[251px] bg-primaryColor rounded-[20px] mt-[14px]"></div>
          <p className="mt-[14px] md:text-[18px] text-white">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua...
          </p>
          <button className="px-[35.5px] py-[15px] md:text-[18px] text-[9.11px] font-[400] rounded-full border border-primaryColor text-primaryColor mt-[42px]">
            Connect Wallet
          </button>
        </div>
